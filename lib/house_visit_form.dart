              ...
              child: Form(
                ...
                child: Padding(
                  ...
                  child: SingleChildScrollView(child: Column(
                    ...
                    <Widget>[
                      SizedBox(height: 20),
                      _buildTextField2(AppLocalizations.of(context)!.branch, _BranchNameController, TextInputType.text,addReg),
                      _buildTextField2(AppLocalizations.of(context)!.area, _AreaCodeController, TextInputType.text,addReg),
                      _buildTextField2(AppLocalizations.of(context)!.group, _GroupCodeController, TextInputType.text,addReg),
                      _buildTextField2(AppLocalizations.of(context)!.center, _CenterController, TextInputType.text,addReg),
