...
class _CameraScreenState extends State<CameraScreen> {
  ...
  Future<File> addTextToImage(String imagePath, String text) async {
    ...
    img.fillRect(decodedImage, x1: 20, y1: decodedImage.height-210, x2: decodedImage.width-20, y2: decodedImage.height-10, color:  img.ColorFloat16.rgba(0.0, 0.0, 0.0,.5));
    ...
    final modifiedImagePath = join(directory!.path, '${DateTime.now().millisecondsSinceEpoch}.png');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
       ...
       ,
          Positioned(
                bottom: 20,left: MediaQuery.of(context).size.width/2-40,
              child: InkWell(
                onTap: () async {
                  String imageText="";
                ...
                child: Card(
                  color: Colors.black,
                  shape: CircleBorder(),
                  child: Container(height: 60,width: 60,child: Center(child: Icon(Icons.camera,size: 60,color: Colors.white,),),),),
              ))
