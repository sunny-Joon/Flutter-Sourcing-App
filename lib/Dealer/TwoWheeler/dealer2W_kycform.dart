...
class _DealerKYCPage2WState extends State<DealerKYCPage2W> {
  ...
  List<String> vehicleType = ['Select', 'EV', 'Non EV'];
  List<String> vehicleTypes = ['Select', 'EV', 'Non EV'];
  List<String> dealerTypes = ['Select', 'EV', 'Non EV'];
  ...
  @override
  void initState() {
    setQRData(widget.result);
  //  _currentStep = widget.state;
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                    child: _buildTextField2(
                        'Middle Name', _nameMController, TextInputType.name,
                        30)),
                SizedBox(width: 10),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: DropdownButton<String>(
                            ...
                            items: relationwithBorrower.map<DropdownMenuItem<
                                String>>(
                                    (RangeCategoryDataModel state) {
                                  return DropdownMenuItem<String>(
                                    value: state.code,
            ...
            Row(
              children: [
                Expanded(
                  child: _buildTextField2(
                      'Mobile no', _mobileNoController, TextInputType.number,
                      10),
                ),
                SizedBox(width: 5),
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
                  ...
                  Container(
                    ...
                    child: DropdownButton<String>(
                      ...
                      items: vehicleTypes.map((
                          String value) { // Make sure this list exists
                        return DropdownMenuItem<String>(
                          value: value,
                          child: Text(value),
                        );
              ...
              Flexible(child: Column(children: [
                ...
                Container(
                  ...
                  child: DropdownButton<String>(
                    ...
                    onChanged: (String? newValue) {
                      setState(() {
                        selectedDealerType = newValue!;
                      });
                    },
                    items: dealerTypes.map((
                        String value) { // Make sure this list exists
                      return DropdownMenuItem<String>(
                        value: value,
                        child: Text(value),
          ...
          _buildTextField2('MSP', MSPController, TextInputType.number, 7),
          _buildTextField2('Ex-Showroom Price', ExShowroomPriceController,
              TextInputType.number, 7),
          _buildTextField2(
              'RTO Price', RTOPriceController, TextInputType.number, 7),
          _buildTextField2('Insurance Price', InsurancePriceController,
              TextInputType.number, 7),
          _buildTextField2(
              'Invoice Value', InvoiceValueController, TextInputType.number, 7),
          _buildTextField2(
  ...
  Widget _buildLabeledDropdownField<T>(String labelText,
      String label,
      List<T> items,
      T? selectedValue,
  ...
  List<int> decompressData(List<int> byteScanData) {
    ...
    String hexData = byteScanData
        .map((byte) => byte.toRadixString(13).padLeft(2, '0'))
        .join(' ');
  ...
  void docVerifyIDC(String type, String txnNumber, String ifsc,
      String dob) async {
    EasyLoading.show(
      status: 'Loading...',
    );
    ...
    if (dataList.length > 14) {
      if (dataList[0].toLowerCase().startsWith("v")) {
        ...
        if (dataList[0].toLowerCase() == 'v2') {
          ...
          String address =
              "${dataList[10]},${dataList[11]},${dataList[13]},${dataList[15]},${dataList[13]}";
...
/*  void _showPopup(BuildContext context, Function(String) onResult) {
  ...
  bool firstPageFieldVelidate() {
    if (_aadharIdController.text.isEmpty) {
      ...
      return false;
    } else if (!(int.parse(_incomeController.text) <= 25000 &&
  ...
  /*Future<void> saveFiMethod(BuildContext context) async {
    ...
    //  String bCode = widget.BranchData.branchCode.toString();
      ...
      String ExShowroomPrice = ExShowroomPriceController.text.toString();
      String RTOPrice = RTOPriceController.text.toString();
      String InsurancePrice = InsurancePriceController.text.toString();
      String InvoiceValue = InvoiceValueController.text.toString();
      String MSP = MSPController.text.toString();
      String? Image;
      if (_imageFile == null) {
        Image = 'Null';
      }
  ...
  Future<void> saveIDsMethod(BuildContext context) async {
    ...
    String? DLExpireDate = _dlExpiryController.text
        .toString()
        .isEmpty
        ? null
...
*/
    ...
    Map<String, dynamic> requestBody = {
      ...
      "Aadhar_Name":
      "${_nameController.text} ${_nameMController.text} ${_nameLController
          .text}",
    ...
    return await api
      ...
      if (value.statuscode == 200) {
        ...
        GlobalClass.showSuccessAlert(
            context,
            "KYC Saved with ${Fi_Code} and ${GlobalClass
                .creator} successfully!! \nPlease note these details for further process",
            2);
      } else {
        EasyLoading.dismiss();
