...
class DealerCrif extends StatefulWidget {
  ...
  @override
  _DealerCrifState createState() => _DealerCrifState();
}

class _DealerCrifState extends State<DealerCrif> with SingleTickerProviderStateMixin {
...
/*Future<void> initializeCrif(BuildContext context) async {
    ...
    return await api.generateCrif(*/
/*GlobalClass.creator*//*"BAREILLY", "261879").then((value) {
