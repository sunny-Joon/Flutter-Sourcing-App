              ...
              child: GestureDetector(
                onTap: () {
                  if (_drivingLicenseController.text.isEmpty ||
                    ...
                    dlVerifyByProtean(
                        GlobalClass.id, _drivingLicenseController.text, dlDob!);
                  }
                },
                child: Container(
                  padding: EdgeInsets.all(3),
                ...
                Row(
                  ...
                  Flexible(child: Column(
                    ...
                    Container(
                      ...
                      child: DropdownButton<String>(
                        value: selectedVehicleType, // Make sure this variable exists
                        isExpanded: true,
                        iconSize: 24,
                        elevation: 13,
                        style: TextStyle(
                        ...
                        items: vehicleTypes.map((String value) { // Make sure this list exists
                          return DropdownMenuItem<String>(
                            value: value,
                            child: Text(value),
                          );
                  ...
                  Flexible(child: Column(children: [
                    ...
                    Container(
                      ...
                      child: DropdownButton<String>(
                        value: selectedDealerType, // Make sure this variable exists
                        isExpanded: true,
                        iconSize: 24,
                        elevation: 13,
                        style: TextStyle(
                        ...
                        items: dealerTypes.map((String value) { // Make sure this list exists
                          return DropdownMenuItem<String>(
                            value: value,
                            child: Text(value),
                          );
